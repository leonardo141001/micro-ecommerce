...
document.getElementById('finish-btn').addEventListener('click', function () {
    ...
    if (name && address) {
        ...
        // URL base para o WhatsApp Web
        const whatsappWebURL = 'https://web.whatsapp.com/send?phone=+5562998002926&text=' + encodeURIComponent(message);
        
        // URL base para o WhatsApp Mobile
        const whatsappMobileURL = 'whatsapp://send?phone=+5562998002926&text=' + encodeURIComponent(message);

        // Verifica se o usuário está em um dispositivo móvel
        const isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);

        // Abre o WhatsApp Web ou o WhatsApp do celular com a mensagem montada
        if (isMobile) {
            // Abre o WhatsApp no celular
            window.location.href = whatsappMobileURL;
        } else {
            // Abre o WhatsApp Web no computador
